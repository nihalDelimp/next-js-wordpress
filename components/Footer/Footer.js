...
function Footer() {
    return (
        <footer className="site-footer" id="sec12" itemScope="itemscope" itemID="#colophon">
                    ...
                    <div className="ast-builder-footer-grid-columns site-primary-footer-inner-wrap ast-builder-grid-row">
                        <div className="site-footer-primary-section-1 site-footer-section site-footer-section-1">
                            <aside className="footer-widget-area widget-area site-footer-focus-item footer-widget-area-inner" data-section="sidebar-widgets-footer-widget-1" aria-label="Footer Widget 1">
                                <section id="nav_menu-7" className="widget widget_nav_menu"><h2 className="widget-title">Services</h2><nav className="menu-services-footer-container" aria-label="Services"><ul id="menu-services-footer" className="menu"><li id="menu-item-1065" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1065"><Link href="/smart-solutions" className="menu-link"><a>Smart Solutions</a></Link></li>
                                    ...
                                    <li id="menu-item-1063" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1063"><Link href="/applications" className="menu-link"><a>Applications</a></Link></li>
                        ...
                        <div className="site-footer-primary-section-2 site-footer-section site-footer-section-2">
                            <aside className="footer-widget-area widget-area site-footer-focus-item footer-widget-area-inner" data-section="sidebar-widgets-footer-widget-3" aria-label="Footer Widget 3">
                                <section id="nav_menu-9" className="widget widget_nav_menu"><h2 className="widget-title">Insights</h2><nav className="menu-insights-footer-container" aria-label="Insights">
                                    <ul id="menu-insights-footer" className="menu">
                                    <li id="menu-item-1073" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1073"><Link href="/white-paper/" className="menu-link">White Paper</Link></li>
                        ...
                        <div className="site-footer-primary-section-3 site-footer-section site-footer-section-3">
                            <div className="footer-widget-area widget-area site-footer-focus-item ast-footer-html-2" data-section="section-fb-html-2">
                                <div className="ast-header-html inner-link-style-"><div className="ast-builder-html-element"><h2 className="small-heading text-grey mb-4 font-bold">Get in Touch</h2>
                                    <ul className="nav social-nav flex-row align-items-center">
                                        <li className="nav-item cursor-pointer mr-1 mb-2">
                                            <a className="nav-link social-media-icon" href="tel:+966 92000 6111"><i className="fas fa-phone"></i></a>
                                        </li>
                                        <li className="nav-item cursor-pointer mr-1 mb-2">
                                            <a className="nav-link social-media-icon" href="https://www.facebook.com/alfanar" target="_blank"><i className="fab fa-facebook-square"></i> </a>
                                        </li>
                                        <li className="nav-item cursor-pointer mr-1 mb-2">
                                            <a className="nav-link social-media-icon" href="https://www.youtube.com/user/alfanartv" target="_blank"><i className="fab fa-youtube"></i> </a>
                                        </li>
                                        <li className="nav-item cursor-pointer mr-1 mb-2">
                                            <a className="nav-link social-media-icon" href="https://twitter.com/alfanar" target="_blank"><i className="fab fa-twitter"></i></a>
                                        </li>
                                        <li className="nav-item cursor-pointer mr-1 mb-2">
                                            <a className="nav-link social-media-icon" href="https://www.linkedin.com/company/alfanar-construction/mycompany" target="_blank"><i className="fab fa-linkedin-in"></i></a>
                                        </li>
                                        <li className="nav-item cursor-pointer mb-2">
                                            <a className="nav-link social-media-icon" href="https://www.instagram.com/alfanar_co/" target="_blank"><i className="fab fa-instagram"></i></a>
                                        </li>
                                    </ul>
                                </div></div></div>
                        </div>
                    ...
                    <div className="ast-builder-footer-grid-columns site-below-footer-inner-wrap ast-builder-grid-row">
                        <div className="site-footer-below-section-1 site-footer-section site-footer-section-1">
                            <div className="ast-builder-layout-element ast-flex site-footer-focus-item ast-footer-copyright" data-section="section-footer-builder">
                                <div className="ast-footer-copyright"><div className="container-copy pt-2 pb-2">
                                    <div className="mx-lg-6 mx-3">
                                        <div className="row p-0">
                                            <div className="col-lg-12 col-md-12 col-12 d-flex flex-md-row flex-column align-items-center justify-content-lg-start justify-content-center">
                                                <img className="alignnone size-medium alfanar-image-50" src="https://wpstorage10fd4cc6f0.blob.core.windows.net/wpblob10fd4cc6f0/wp-content/uploads/2022/11/logo-updated-color-300x124.png" alt="logo" width="300" height="124" /><p></p>
                                                <p className="copyright-text text-md-left font-weight-medium mb-0 mx-4">Copyright © 2022 alfanar Digital Solutions.<br />
