...
import Description from './../SinglePost/Description';
                    ...
                    <div className="row pt-8 pb-4 pt-lg-1 pb-lg-1">
                        <div className="col-lg-12 text-left">
                            <ul className="alfanar-breadcrumb font-bold no-margin-bottom">
                                ...
                                <li className="alfanar-breadcrumb-item" aria-current="page"><a className="text-white" href="#">Industries : Government and Semi-Government Industry</a></li>
                            </ul>
                        </div>
                    </div>
                    <div className="row">
                        <div className="pt-2 pb-2 col-lg-6 align-self-center wow">
                            <h1 className="text-white font-bold bottom-buffer-2point5rem">{govermentData[0]?.heading}</h1>
                            <p className="text-white font-medium extra-large">{govermentData[0]?.description}</p>
                        </div>
                        <div className="pt-2 pb-2 col-lg-6 align-self-center text-lg-right text-center wow">
                            <img className="w-100" src={govermentData[0]?.image?.sourceUrl} />
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="row pt-4 pb-4 pt-lg-5 pb-lg-5">
                        <div className="col-lg-6 my-auto wow slideInRight  pt-4 pb-4" data-wow-duration="2s" data-wow-delay="250ms">
                            <h1 className="text-primary font-bold  bottom-buffer-1point5rem">
                                {govermentData[1]?.heading}
                            </h1>
                            <p className="extra-large" style={{ color: "#808080" }}>{govermentData[1]?.description}</p>
                        </div>
                        <div className="col-lg-6 wow slideInLeft  pl-lg-8" data-wow-duration="2s" data-wow-delay="250ms">
                            {govermentData[1]?.listItems && govermentData[1]?.listItems.length > 0 &&
                                govermentData[1].listItems.map((item, index) =>
                ...
                <div id="industry-container" className="container-lg pb-4 pt-4 pb-lg-6 pt-lg-6">
                    <div className="row">
                        <div className="col-lg-12 text-center pb-4 pt-4 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                            <h1 className="text-white font-bold  bottom-buffer-2point5rem">{govermentData[2]?.heading}</h1>
                            <p className="text-white extra-big font-medium ">{govermentData[2]?.description}</p>
                        </div>
                    </div>
                    <div className="row">
                        {govermentData[2].cardBox && govermentData[2].cardBox.length > 0 &&
                            govermentData[2].cardBox.map((item, index) =>
                ...
                <div id="top-clients-container" className="container-lg pb-4 pt-4">
                    <div className="row pb-4 pt-4 wow pulse" data-wow-duration="2s">
                        <div className="col-12 text-center">
                            <h1 className="font-weight-bold">{govermentData[3]?.heading}</h1>
                        </div>
                    </div>
