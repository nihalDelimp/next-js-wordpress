...
function EnergyAndUtility({ energyData }) {
    return (
        <div>
                    ...
                    <div className="row pt-8 pb-4 pt-lg-1 pb-lg-1">
                        <div className="col-lg-12 text-left">
                            <ul className="alfanar-breadcrumb font-bold no-margin-bottom">
                                ...
                                <li className="alfanar-breadcrumb-item" aria-current="page"><a className="text-white" href="#">Industries : Energy & Utility</a></li>
                            </ul>
                        </div>
                    </div>
                    <div className="row">
                        <div className="pt-2 pb-2 col-lg-6 align-self-center wow">
                            <h1 className="text-white font-bold bottom-buffer-2point5rem">{energyData[0]?.heading}</h1>
                            <p className="text-white font-medium extra-large">{energyData[0]?.description}</p>
                        </div>
                        <div className="pt-2 pb-2 col-lg-6 align-self-center text-lg-right text-center wow">
                            <img className="w-100" src={energyData[0]?.image?.sourceUrl} />
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="row pt-4 pb-4 pt-lg-5 pb-lg-5">
                        <div className="col-lg-6 my-auto wow slideInRight  pt-4 pb-4" data-wow-duration="2s" data-wow-delay="250ms">
                            <h1 className="text-primary font-bold  bottom-buffer-1point5rem">
                                {energyData[1]?.heading}
                            </h1>
                            <p className="extra-large" style={{ color: "#808080" }}>{energyData[1]?.description}</p>
                        </div>
                        <div className="col-lg-6 wow slideInLeft  pl-lg-8" data-wow-duration="2s" data-wow-delay="250ms">
                            {energyData[1]?.listItems && energyData[1]?.listItems.length > 0 &&
                                energyData[1].listItems.map((item, index) =>
                ...
                <div id="industry-container" className="container-lg pb-4 pt-4 pb-lg-6 pt-lg-6">
                    <div className="row">
                        <div className="col-lg-12 text-center pb-4 pt-4 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                            <h1 className="text-white font-bold  bottom-buffer-2point5rem">{energyData[2]?.heading}</h1>
                            <p className="text-white extra-big font-medium ">{energyData[2]?.description}</p>
                        </div>
                    </div>
                    <div className="row">
                        {energyData[2].cardBox && energyData[2].cardBox.length > 0 &&
                            energyData[2].cardBox.map((item, index) =>
                ...
                <div id="top-clients-container" className="container-lg pb-4 pt-4">
                    <div className="row pb-4 pt-4 wow pulse" data-wow-duration="2s">
                        <div className="col-12 text-center">
                            <h1 className="font-weight-bold">{energyData[3]?.heading}</h1>
                        </div>
                    </div>
                            ...
                            <div className="swiper-alfanar">
                                <div className="swiper-container top-clients-swiper">
                                    <div className="swiper-wrapper">
                                        {energyData[3].carouselImages && energyData[3].carouselImages.length > 0 &&
                                            energyData[3].carouselImages.map((item, index) =>
...
export default EnergyAndUtility
